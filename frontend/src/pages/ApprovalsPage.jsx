  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Persetujuan</h1>
        {approvals.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border p-8 text-center text-gray-400">Tidak ada persetujuan pending</div>
        ) : (
